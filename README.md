## Dremio IBM DB2 v11 ARP Connector
The IBM DB2 v11 connector allows Dremio to connect to and query data in IBM DB2 v11. 

## Building and Installation

1. In root directory with the pom.xml file run `mvn clean install`
2. Take the resulting .jar file in the target folder and put it in the$DREMIO_HOME/jars folder in Dremio
3. Take the IBM DB2 v11 JDBC driver  (db2jcc4.jar) from https://www.ibm.com/support/pages/db2-jdbc-driver-versions-and-downloads and put it in the $DREMIO_HOME/jars/3rdparty folder
4. Restart Dremio
